...
layout(location = 3) in vec3 inLightNormal;
...
void main() {
    ...
    vec3 lightNormal = mat3(ubo.proj * ubo.model) * inLightNormal;     
    vec3 lightColor = vec3(max(0.0,dot(lightNormal,vec3(1,1,1))) + 0.1);
    fragColor = inColor;
